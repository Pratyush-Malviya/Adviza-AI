...
import { WorkflowNode, WorkflowEdge, NodeTemplateDefinition } from "@/types/workflow";
import { AVAILABLE_NODE_TEMPLATES } from "@/components/workflows/workflow-templates";
