        ...
        <div className="bg-white rounded-[32px] p-8 sm:p-10 border border-[#EADBCE] shadow-xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="btn-hero-gradient w-full py-3.5 text-white font-bold rounded-full transition-all flex items-center justify-center gap-2 shadow-lg shadow-rose-500/20 disabled:opacity-50"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-5 w-full py-3 bg-white hover:bg-[#FAF5F0] disabled:opacity-50 border border-[#EADBCE] text-[#121217] font-semibold rounded-full transition-colors flex items-center justify-center gap-3 text-sm shadow-sm"
            >
          ...
          <p className="mt-6 text-center text-sm text-[#7A726A]">
