import { AdvizaAgentStateType, MissingConnector } from '../state.js';
import { findCapability } from '../../capabilities/registry.js';
import { getComposioConnections, initiateComposioConnection, SUPPORTED_COMPOSIO_APPS } from '../../../integrations/composio.js';
