import { AdvizaAgentStateType, ExecutedResult } from '../state.js';
import { findCapability } from '../../capabilities/registry.js';
import { executeComposioAction } from '../../../integrations/composio.js';
import { generateClientBriefing } from '../../../agents/briefing-agent.js';
import { generateComplianceRecord } from '../../../agents/compliance-agent.js';
