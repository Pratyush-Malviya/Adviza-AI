...
import { Mail, ArrowLeft, Send, CheckCircle2, Sparkles, Building, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="bg-white p-5 rounded-3xl border border-[#EADBCE] shadow-2xs space-y-4">
              <h2 className="font-heading font-bold text-sm text-[#121217]">Direct Inquiries</h2>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-[#EADBCE] shadow-sm md:col-span-2">
            {submitted ? (
              <div className="py-12 text-center space-y-3 animate-in fade-in zoom-in-95 duration-200">
                ...
                <h2 className="font-heading font-bold text-lg text-[#121217]">Message Received</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="contact-name" className="text-xs font-semibold text-[#121217]">Full Name</label>
                    <input
                      id="contact-name"
                      type="text"
                      required
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="contact-email" className="text-xs font-semibold text-[#121217]">Work Email</label>
                    <input
                      id="contact-email"
                      type="email"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label htmlFor="contact-firm" className="text-xs font-semibold text-[#121217]">Firm Name</label>
                    <input
                      id="contact-firm"
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="contact-aum" className="text-xs font-semibold text-[#121217]">Firm AUM</label>
                    <select
                      id="contact-aum"
                      value={formData.aum}
                ...
                <div className="space-y-1.5">
                  <label htmlFor="contact-msg" className="text-xs font-semibold text-[#121217]">Message or Inquiry</label>
                  <textarea
                    id="contact-msg"
                    required
                    rows={4}
